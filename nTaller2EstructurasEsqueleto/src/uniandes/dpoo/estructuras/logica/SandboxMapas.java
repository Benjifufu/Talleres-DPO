...
public class SandboxMapas
{
    ...
    public List<String> getLlavesComoListaInvertida( )
    {
        ...
        llaves.sort((a, b) -> b.compareTo(a)); // Ordena las llaves de mayor a menor
        return llaves;
    }
    ...
    public int getCantidadCadenasDiferentes( )
    {
    	  Collection<String> valores = mapaCadenas.values();
    	    List<String> valoresUnicos = new ArrayList<>(); // Esto debería reemplazar el HashSet para mantener la restricción de clases permitidas.
    ...
    public boolean compararValores( String[] otroArreglo )
    {
    	 for (String valor : otroArreglo) {
    	        ...
    	        for (String mapaValor : mapaCadenas.values()) {
    	            if (mapaValor.equals(valor)) {
    	                encontrado = true;
    	                break;
    	            }
    	        }
